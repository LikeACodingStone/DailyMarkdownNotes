...
#### 8. Running bat via windows cmd inside FlashScripts_FlashGUI folder
  ...
  - #### waing for result，success is showing like the fellowing
  - ![01f3e5f20676cfb93ab65c32603d41e2.png](01f3e5f20676cfb93ab65c32603d41e2.png)
</div>
...
- #### <span style="color: red;">check if serial number is not changing, no necessary to flash again, move to steps 6</span>
- ![09462c7aff342abb3991439968ada6e9.png](09462c7aff342abb3991439968ada6e9.png)
- #### Flash serial number method
	```
	adb root
	adb shell
